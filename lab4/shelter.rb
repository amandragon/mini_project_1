...
puts "Welcome to Happi Tails! Type next to get to our command list."
...
choice=gets.chomp
	...
	animal_toys=gets.chomp
	happi_tails.add_animal(animal_name,animal_age,animal_gender,animal_species,animal_toys)
	puts "Thank you! Your animal has been put up for adoption. #{happi_tails.display_animals}." #this isn't pretty
	end
end
